  ...
  return (
    <>
      ...
      <header className="sticky top-0 bg-white z-10 shadow">
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-8 py-4 lg:px-8" aria-label="Global">
          ...
          <Popover.Group className="hidden lg:flex lg:gap-x-3">
            <Link to="/taxi-san-bay-cam-ranh" className="text-sm font-semibold leading-6 text-gray-900">
              TRANG CHỦ
            </Link>
                    ...
                    {links.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex-auto">
                          <a to={item.to} className="block font-semibold text-gray-900">
                            {item.name}
            ...
            <Link to="/lien-he" className="text-sm font-semibold leading-6 text-gray-900">
              LIÊN HỆ
            </Link>
          </Popover.Group>
        </nav>
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          <Dialog.Panel
            className={classNames(mobileMenuOpen ? "top-0" : "top-[96px]", "fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10")}    >
            <div className="flex items-center justify-between">
              <Link to="/" className="-m-1.5 p-1.5">
                <span className="sr-only">TAXI</span>
                <img
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                <div className="space-y-2 py-6">
                  ...
                  <Link to="/lien-he" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                    LIÊN HỆ
                  </Link>
                </div>
              </div>
